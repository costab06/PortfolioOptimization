...
$BASEDIR/cots/mysql-connector-java-5.0.4/mysql-connector-java-5.0.4-bin.jar:\
...
date
java -cp $CLASSPATH -Djava.security.policy=src/policy/policy.all com.bcfinancial.cache.PersistenceManagerCacheClient
date
