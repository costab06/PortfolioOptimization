...
public class PieChartDemo2 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(PieDataset dataset) {
        ...
        plot.setSectionPaint(1, new Color(128, 128, 255 - 32));
        plot.setSectionPaint(2, new Color(96, 96, 255 - 64));
        plot.setSectionPaint(3, new Color(64, 64, 255 - 96));
        plot.setSectionPaint(4, new Color(32, 32, 255 - 128));
        plot.setSectionPaint(5, new Color(0, 0, 255 - 144));
